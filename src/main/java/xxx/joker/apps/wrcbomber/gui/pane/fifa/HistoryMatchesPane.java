...
public class HistoryMatchesPane extends BorderPane {
    ...
    private JfxTable<FifaMatch> createFifaTableMatches() {
        ...
        JfxTableCol<FifaMatch, LocalDateTime> colTime = JfxTableCol.createCol("MATCH TIME", "matchTime", m -> m.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")));
        tableView.addColumn(colNum, colTeamFede, golFede, golBomber, colTeamBomber, colWinner, colTime);
        return tableView;
    }
